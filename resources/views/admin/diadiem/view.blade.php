        ...
        <div class="container">
                    ...
                    <div class="post">
                        <div class="post-header">
                            ...
                            <div class="author row">
                                <div class="col-1">
                                    <img src="upload/users/{{ $userAuthor->Avatar }}" class="circle view-admin-img"
            ...
            <div class="row">
                <div class="card-action">
                    <button class="btn green"><a style="color: white"
                            href="admin/diadiem/delete/{{ $DiaDiem->id }}/{{ $user->id }}"> Xoá</a></button>
                    <button class="btn green"><a style="color: white"
                            href="admin/diadiem/duyet/{{ $DiaDiem->id }}/{{ $user->id }}"> Duyệt</a></button>
                    <button class="btn green"><a style="color: white" href="admin/diadiem/list/{{ $user->id }}">
                            Trở lại</a></button>
                </div>
            </div>
        </div>
