...
<div class="container">
    <section class="content px-2 mt-6" >
        ...
        <div class="card-action">
            <button class="btn green"><a href="admin/diadiem/delete/{{$DiaDiem->id}}"> Xoá</a></button>
            <button class="btn green"><a href="admin/diadiem/duyet/{{$DiaDiem->id}}"> Duyệt</a></button>
            <button class="btn green"><a href="admin/diadiem/list"> Trở lại</a></button>
        </div>
        <div class="row"></div>      
    </section>
</div>
