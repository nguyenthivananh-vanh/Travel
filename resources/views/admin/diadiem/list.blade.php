                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 task-button">
                                    ...
                                    <button class="btn-add"><a
                                            href="admin/diadiem/duyetbai/{{ $user->id }}">Duyệt bài</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="header__mobile">
                    ...
                    <div class="row task">
                        ...
                        <div class="col-lg-3 col-md-4  col-sm-5  task-button header__mobile-7">
                            <button class="btn-add"><a href="admin/diadiem/add/{{ $user->id }}"> <i
                                        class="fas fa-plus"></i>Thêm</a></button>
                            <button class="btn-add"><a href="admin/diadiem/duyetbai/{{ $user->id }}">Duyệt
                                    bài</a></button>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($DiaDiem as $diadiem)
                                    @if ($diadiem->TrangThai == 1)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="admin/diadiem/update/{{ $diadiem->id }}/{{ $user->id }}"
                                                    class="green-text">
