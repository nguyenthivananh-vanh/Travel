                ...
                <div class="header__pc">
                        ...
                        <div class="col-7">
                            <div class="row task" style="border-bottom:none">
                                ...
                                <div class="col-6 text-right ">
                                    <button class="btn-add"><a href="admin/video/add/{{ $user->id }}"> <i
                    ...
                    <div class="row task" style="border-bottom:none">
                        <div class="input-group">
                            ...
                            <form action="admin/video/search/{{ $user->id }}" method="POST"
                            ...
                            @foreach ($video as $vid)
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        <a href="admin/video/update/{{ $vid->id }}/{{ $user->id }}"
                                            class="green-text">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <a href="admin/video/delete/{{ $vid->id }}/{{ $user->id }}"
                                            class="red-text">
