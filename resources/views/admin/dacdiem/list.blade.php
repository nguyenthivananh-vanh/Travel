                ...
                <div class="header__pc">
                        ...
                        <div class="col-7">
                            <div class="row task" style="border-bottom:none">
                                ...
                                <div class="col-6 text-right">
                                    <button class="btn-add"><a href="admin/dacdiem/add/{{ $user->id }}"> <i
                    ...
                    <div class="row task" style="border-bottom:none">
                        <div class="input-group">
                            ...
                            <form action="admin/dacdiem/search/{{ $user->id }}" method="POST"
                        ...
                        <tbody>
                            @foreach ($dacdiem as $dd)
                                <tr style="text-align:center">
                                    ...
                                    <td>
                                        <a href="admin/dacdiem/update/{{ $dd->id }}/{{ $user->id }}"
                                            class="green-text">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <a href="admin/dacdiem/delete/{{ $dd->id }}/{{ $user->id }}"
                                            class="red-text">
