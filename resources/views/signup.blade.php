            ...
            <form action="register" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <input type="text" class="form-control pl-2" id="name" name="ten" aria-describedby="nameHelp"
                        placeholder="Enter name" style="text-align:left;" required>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <input type="password" class="form-control pl-2" id="password" name="pass" placeholder="Password"
                        require>
                </div>
                <div class="form-group row">
                    <input type="password" class="form-control pl-2" id="password_rp" name="confirm"
