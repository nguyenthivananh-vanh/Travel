...
<div class="container-fuild">
    <div class="notify delete">
        <div class="form-notify form-delete">
            ...
            <div class="accept ">
                <button class="green"><a href="home/acceptDelete/{{$DiaDiem->id}}/{{$DiaDiem->TacGia}}/{{$user->id}}">Xoá bài</a></button>
    ...
    <div class="notify update">
        <div class="form-notify form-update">
            ...
            <div class="accept">
                <button class="green"><a href="home/updateView/{{$DiaDiem->id}}/{{$DiaDiem->TacGia}}/{{$user->id}}">Sửa địa điểm</a></button>
                @if(isset($monan))
                <button class="green"><a href="home/updateCulinary/{{$DiaDiem->id}}/{{$DiaDiem->TacGia}}/{{$user->id}}" > Sửa Món Ăn</a></button>
                @endif
                @if(isset($video))
                <button class="green"><a href="home/updateVideo/{{$DiaDiem->id}}/{{$DiaDiem->TacGia}}/{{$user->id}}/{{$video->id}}">Sửa video</a></button>
                                    ...
                                    <ul>
                                        ...
                                        @if(isset($user))
                                            @if($user->id === $cmt->idUser)
                                                <li>
                                                    <a href="home/deleteCmt/{{$cmt->id}}/{{$cmt->idDiaDiem}}/{{$DiaDiem->TacGia}}/{{$user->id}}"><i
