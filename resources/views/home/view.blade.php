            ...
            <div class="modal-content" style="width:500px">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn red"
                        onclick="document.getElementById('deletePost').style.display='none'" class="deletebtn">Xóa
                        bài</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content" style="width:800px;z-index:10">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success"
                        onclick="document.getElementById('editPost').style.display='none'" class="cancelbtn">Địa
                        điểm</button>
                    <button type="button" class="btn btn-success"
                        onclick="document.getElementById('editPost').style.display='none'" class="cancelbtn">Đặc
                        sản</button>
                    <button type="button" class="btn btn-success"
