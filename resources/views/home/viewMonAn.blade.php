    ...
    <div class="wrap">
        <section class="container-fuild">
            <div class="contanier-detail" style="width:100vw">
                <img src="upload/monan/{{ $monan->HinhAnh }}" style="height:70vh; width: 100vw" alt=""
                    class="post-img">
                @if (isset($user))
                    <a href="home/home/{{ $user->id }}" class="logo" tyle="margin 0 auto"><img
                            src="upload/home/myVietnam-big1.png" alt="logo" style="width: 200px; height:54px"></a>
                @else
                    <a href="home/home" class="logo" style="margin 0 auto"><img
                            src="upload/home/myVietnam-big1.png" alt="logo" style="width: 200px; height:54px"></a>
                @endif
        ...
        <div class="container">
            <div class="row monan-title">
                <h3 class="title" style="color:#277fbc ;font-family:'Alice';sans-serif"> {{ $monan->TenMonAn }}
                </h3><br>
                                    ...
                                    <li class="list-sub-item">
                                        <div class="row">
                                            ...
                                            <div class="col-8 item-text">
                                                @if (isset($user))
                                                    <p> <a
                                                            href="home/viewMonAn/{{ $ma->id }}/{{ $ma->idDiaDiem }}/{{ $user->id }}">{{ $ma->TenMonAn }}<br>
                                                        @else
                                                            <p> <a
                                                                    href="home/viewMonAn/{{ $ma->id }}/{{ $ma->idDiaDiem }}">{{ $ma->TenMonAn }}<br>
                                                @endif
                                                <span style="color: black; font-size: 14px">{{ $ma->TieuDe }}</span></a>
                                                </p>
