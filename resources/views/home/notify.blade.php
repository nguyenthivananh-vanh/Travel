...
<div class="container-fuild ">  
    ...
    <div class="notify--show  ">
        ...
        <div class="form-notify ">        
            ...
            <div class="accept ">
                <button class="btn btn-secondary green"><a href="home/getVideo/{{$id}}/{{$idDiaDiem}}">Video</a></button>
                <button class="btn btn-secondary green"><a href="home/getCulinary/{{$id}}/{{$idDiaDiem}}">Đặc sản</a></button>
